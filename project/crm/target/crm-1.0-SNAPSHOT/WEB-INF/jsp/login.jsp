			...
			$("#loginBtn").click(function () {
				...
				$.ajax({
					...
					success: function (data) {
						// data: {success: true/false, msg: "xxxxxx"}
						if ( data.msg ) {
							alert(data.msg);
						}
						if ( data.success ) {
			...
			<form action="workbench/index.jsp" class="form-horizontal" role="form">
				<div class="form-group form-group-lg">
					<div style="width: 350px;">
						<input class="form-control" value="root" id="username" type="text" placeholder="用户名">
					</div>
					<div style="width: 350px; position: relative;top: 20px;">
						<input class="form-control" value="1234" id="password" type="password" placeholder="密码">
					</div>
